/*
Project VorteX World DB Structure
Revision: R18A
Patch: 4.0.6
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`vortex_r11` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `arkcore_string` */
...
CREATE TABLE `conditions` (
  ...
  `NegativeValue` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6600588 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
CREATE TABLE `creature_ai_scripts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=800011384 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Scripts';
...
CREATE TABLE `creature_ai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Summoning Locations';
...
CREATE TABLE `creature_text` (
  ...
  `sound` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `content_loc1` longtext,
  `content_loc2` longtext,
  `content_loc3` longtext,
  `content_loc4` longtext,
  `content_loc5` longtext,
  `content_loc6` longtext,
  `content_loc7` longtext,
  `content_loc8` longtext,
  `comment` varchar(255) DEFAULT '',
  PRIMARY KEY (`entry`,`groupid`,`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Creature texts';
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10020 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `gameobject` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=70732 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='CTDB Start player info';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='CTDB Start player actions';
...
CREATE TABLE `quest_template` (
  ...
  `RewSpellHiddenCast` int(11) unsigned NOT NULL DEFAULT '0',
